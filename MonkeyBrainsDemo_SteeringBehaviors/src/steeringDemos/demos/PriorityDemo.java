...
public class PriorityDemo extends BasicDemo {
    ...
    {
            private DebugCompoundSteeringBehaviour(Agent agent) { super(agent); } 
    ...
    {     
        ...
        game.addAgent(seeker); //Add the target to the game
        game.getGameControl().spawn(seeker, new Vector3f(10,10,10));
        this.setStats
                (
                    seeker,
        ...
        this.currentFocus = 0;
             ArrayList<Agent> separationObstacle = new ArrayList<Agent>();
    ...
    public void simpleUpdate(float tpf) {
        ...
        if(this.seeker.distanceRelativeToAgent(this.target) < 0.25f)
